...
public class QSkill extends EntityPathBase<Skill> {
    ...
    public final ListPath<kernel.jdon.wantedjdskill.domain.WantedJdSkill, kernel.jdon.wantedjdskill.domain.QWantedJdSkill> wantedJdSkillList = this.<kernel.jdon.wantedjdskill.domain.WantedJdSkill, kernel.jdon.wantedjdskill.domain.QWantedJdSkill>createList("wantedJdSkillList", kernel.jdon.wantedjdskill.domain.WantedJdSkill.class, kernel.jdon.wantedjdskill.domain.QWantedJdSkill.class, PathInits.DIRECT2);
