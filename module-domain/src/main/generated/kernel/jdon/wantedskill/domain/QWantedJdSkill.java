...
public class QWantedJdSkill extends EntityPathBase<WantedJdSkill> {
    ...
    private static final long serialVersionUID = 141645550L;
    ...
    public final kernel.jdon.wanted.domain.QWantedJd wantedJd;
    ...
    public QWantedJdSkill(Class<? extends WantedJdSkill> type, PathMetadata metadata, PathInits inits) {
        ...
        this.wantedJd = inits.isInitialized("wantedJd") ? new kernel.jdon.wanted.domain.QWantedJd(forProperty("wantedJd"), inits.get("wantedJd")) : null;
    }
