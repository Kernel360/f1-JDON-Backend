...
public class QInflearnJdSkill extends EntityPathBase<InflearnJdSkill> {
    ...
    private static final long serialVersionUID = 960008328L;
    ...
    public final kernel.jdon.wantedskill.domain.QWantedJdSkill wantedJdSkill;
    ...
    public QInflearnJdSkill(Class<? extends InflearnJdSkill> type, PathMetadata metadata, PathInits inits) {
        ...
        this.wantedJdSkill = inits.isInitialized("wantedJdSkill") ? new kernel.jdon.wantedskill.domain.QWantedJdSkill(forProperty("wantedJdSkill"), inits.get("wantedJdSkill")) : null;
    }
