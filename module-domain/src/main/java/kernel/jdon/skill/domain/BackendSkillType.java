...
public enum BackendSkillType implements SkillType {
	...
	PYTHON("Python", "파이썬", Arrays.asList("Django", "Flask", "장고", "플라스크")),
	MYSQL("MySQL", "MySQL", Arrays.asList("Database", "SQL", "DB", "데이터베이스")),
	JAVA("Java", "자바", Arrays.asList("Spring", "JPA", "스프링")),
	SPRING_FRAMEWORK("Spring Framework", "스프링 프레임워크",
		Arrays.asList("Spring Boot", "Spring MVC", "스프링", "스프링 부트", "스프링 MVC")),
	GITHUB("Github", "깃허브", Arrays.asList("Version Control", "Code Hosting", "깃")),
	DOCKER("Docker", "도커", Arrays.asList("Containerization", "DevOps", "컨테이너", "데브옵스")),
	KOTLIN("Kotlin", "코틀린", Arrays.asList("Android", "JVM Languages", "안드로이드")),
	NODEJS("Node.js", "노드.js", Arrays.asList("JavaScript", "Server-side", "노드")),
	SQL("SQL", "SQL", Arrays.asList("Database", "Query Language", "쿼리", "DB")),
	LINUX("Linux", "리눅스", Arrays.asList("Operating System", "Unix", "운영체제", "OS")),
	SPRING_BOOT("Spring Boot", "스프링 부트", Arrays.asList("Microservices", "Spring", "마이크로서비스")),
	...
	POSTGRESQL("PostgreSQL", "포스트그레SQL", Arrays.asList("Database", "SQL", "데이터베이스")),
	RESTFUL_API("Restful API", "RESTful API", Arrays.asList("Web Services", "HTTP", "Rest")),
	MONGODB("MongoDB", "몽고DB", Arrays.asList("NoSQL", "Document Database", "몽고디비", "몽고")),
	DJANGO("Django", "장고", Arrays.asList("Python", "Web Framework", "파이썬")),
	...
	C("C", "C", Arrays.asList("Programming Language", "System Programming", "C언어")),
	...
	RABBITMQ("RabbitMQ", "래빗MQ", Arrays.asList("Message Broker", "AMQP", "래빗")),
