...
public enum BackendSkillType implements SkillType {
    ...
    MYSQL("MySQL", "MySQL", Arrays.asList("Database", "SQL", "DB", "데이터베이스", "마이SQL")),
    ...
    C_PLUS_PLUS("C++", "C++", Arrays.asList("Programming Language", "Object-oriented", "C쁠쁠")),
    ...
    MONGODB("MongoDB", "몽고DB", Arrays.asList("NoSQL", "Document Database", "몽고디비", "몽고", "몽고 DB")),
    ...
    RDBMS("RDBMS", "RDBMS", Arrays.asList("Relational Database", "SQL", "데이터베이스", "관계형 DB", "관계형DB")),
    ...
    TDD("TDD", "테스트 주도 개발", Arrays.asList("Test-Driven Development", "Test Driven Development", "테스트")),
