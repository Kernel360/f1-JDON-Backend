package kernel.jdon.modulecrawler.wanted.service;
...
import kernel.jdon.modulecrawler.global.error.code.WantedErrorCode;
import kernel.jdon.modulecrawler.global.error.exception.CrawlerException;
import kernel.jdon.modulecrawler.wanted.dto.response.WantedJobDetailResponse;
import kernel.jdon.modulecrawler.wanted.dto.response.WantedJobListResponse;
import kernel.jdon.modulecrawler.wanted.repository.JobCategoryRepository;
import kernel.jdon.modulecrawler.wanted.repository.SkillHistoryRepository;
import kernel.jdon.modulecrawler.wanted.repository.SkillRepository;
import kernel.jdon.modulecrawler.wanted.repository.WantedJdRepository;
import kernel.jdon.modulecrawler.wanted.repository.WantedJdSkillRepository;
import kernel.jdon.modulecrawler.wanted.search.JobSearchExperience;
import kernel.jdon.modulecrawler.wanted.search.JobSearchJobCategory;
import kernel.jdon.modulecrawler.wanted.search.JobSearchJobPosition;
import kernel.jdon.modulecrawler.wanted.search.JobSearchLocation;
import kernel.jdon.modulecrawler.wanted.search.JobSearchSort;
import kernel.jdon.modulecrawler.wanted.service.infrastructure.JobDetailProcessingCounter;
import kernel.jdon.modulecrawler.wanted.service.infrastructure.JobListProcessingCounter;
import kernel.jdon.modulecrawler.wanted.skill.SkillType;
