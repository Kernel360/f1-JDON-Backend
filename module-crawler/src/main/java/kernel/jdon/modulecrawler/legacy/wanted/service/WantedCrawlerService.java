package kernel.jdon.modulecrawler.legacy.wanted.service;
...
import kernel.jdon.modulecrawler.legacy.global.error.code.WantedErrorCode;
import kernel.jdon.modulecrawler.legacy.jobcategory.repository.JobCategoryRepository;
import kernel.jdon.modulecrawler.legacy.skill.repository.SkillRepository;
import kernel.jdon.modulecrawler.legacy.skillhistory.repository.SkillHistoryRepository;
import kernel.jdon.modulecrawler.legacy.wanted.dto.response.WantedJobDetailResponse;
import kernel.jdon.modulecrawler.legacy.wanted.dto.response.WantedJobListResponse;
import kernel.jdon.modulecrawler.legacy.wanted.repository.WantedJdRepository;
import kernel.jdon.modulecrawler.legacy.wanted.repository.WantedJdSkillRepository;
import kernel.jdon.modulecrawler.legacy.wanted.search.JobSearchExperience;
import kernel.jdon.modulecrawler.legacy.wanted.search.JobSearchJobCategory;
import kernel.jdon.modulecrawler.legacy.wanted.search.JobSearchJobPosition;
import kernel.jdon.modulecrawler.legacy.wanted.search.JobSearchLocation;
import kernel.jdon.modulecrawler.legacy.wanted.search.JobSearchSort;
import kernel.jdon.modulecrawler.legacy.wanted.service.infrastructure.JobDetailProcessingCounter;
import kernel.jdon.modulecrawler.legacy.wanted.service.infrastructure.JobListProcessingCounter;
