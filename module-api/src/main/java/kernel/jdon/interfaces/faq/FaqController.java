...
import kernel.jdon.application.faq.FaqFacade;
...
public class FaqController {
	...
	public ResponseEntity<CommonResponse> save(@RequestBody @Valid FaqDto.CreateRequest request) {
	...
	public ResponseEntity<CommonResponse> modify(@RequestBody @Valid FaqDto.UpdateRequest request) {
